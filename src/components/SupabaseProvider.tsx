  ...
  const syncData = async () => {
    ...
    try {
      ...
      const pullFromCloud = async () => {
        ...
        } catch (e) { console.warn("Pull journal_entries failed:", e); }
        ...
        } catch (e) { console.warn("Pull ebenezer_stones failed:", e); }
        ...
        } catch (e) { console.warn("Pull game_progress failed:", e); }
        ...
        } catch (e) { console.warn("Pull gratitude_grains failed:", e); }
        ...
        } catch (e) { console.warn("Pull spanish_words failed:", e); }
      };
      ...
      const pushToCloud = async () => {
        ...
        } catch (e) { console.warn("Push journal_entries failed:", e); }
        ...
        } catch (e) { console.warn("Push ebenezer_stones failed:", e); }
        ...
        } catch (e) { console.warn("Push game_progress failed:", e); }
        ...
        } catch (e) { console.warn("Push gratitude_grains failed:", e); }
        ...
        } catch (e) { console.warn("Push spanish_words failed:", e); }
      };
