...
import { Code, Eye, Layers, Palette, Cpu, Github, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 text-white min-h-screen">
      ...
      <div className="grid md:grid-cols-2 gap-8 relative">
        ...
        <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-px bg-gradient-to-r from-transparent via-sky-500/20 to-transparent z-0" />
      ...
      <motion.div 
        ...
        className="mt-20 p-12 bg-gradient-to-br from-zinc-900 to-black rounded-[4rem] border border-white/10 text-center relative overflow-hidden group"
      >
